			...
			<div class="card card-body rounded-0">
				<a href="<?php echo esc_url( get_admin_url() . 'admin.php?page=wc-settings&tab=wcdn-settings&setting=wcdn_document&wdcn_setting=wcdn_invoice' ); ?>">
					<div class="d-flex align-items-center justify-content-between card-padding">
						...
						<p class="card-text">
							<label class="switch">
								<input type="checkbox" name="wcdn_document[]" value="invoice" <?php echo esc_attr( ! empty( $wcdn_document_settings ) && in_array( 'invoice', $wcdn_document_settings, true ) ? 'checked' : '' ); ?>>
			...
			<div class="card card-body rounded-0">
				<a href="<?php echo esc_url( get_admin_url() . 'admin.php?page=wc-settings&tab=wcdn-settings&setting=wcdn_document&wdcn_setting=wcdn_receipt' ); ?>">
					<div class="d-flex align-items-center justify-content-between card-padding">
						...
						<p class="card-text">
							<label class="switch">
								<input type="checkbox" name="wcdn_document[]" value="receipt" <?php echo esc_attr( ! empty( $wcdn_document_settings ) && in_array( 'receipt', $wcdn_document_settings, true ) ? 'checked' : '' ); ?> >
								<span class="slider round"></span>
							</label>
						</p>
					</div>
			...
			<div class="card card-body rounded-0">
				<a href="<?php echo esc_url( get_admin_url() . 'admin.php?page=wc-settings&tab=wcdn-settings&setting=wcdn_document&wdcn_setting=wcdn_deliverynote' ); ?>">
					<div class="d-flex align-items-center justify-content-between card-padding">
						...
						<p class="card-text">
							<label class="switch">
								<input type="checkbox"  name="wcdn_document[]" value="delivery_note" <?php echo esc_attr( ! empty( $wcdn_document_settings ) && in_array( 'delivery_note', $wcdn_document_settings, true ) ? 'checked' : '' ); ?> >
								<span class="slider round"></span>
							</label>
						</p>
					</div>
