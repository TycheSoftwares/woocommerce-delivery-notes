...
class Settings extends \Tyche\WCDN\Api\Api {
	...
	public static function default_settings() {
		...
		return array(
			...
			'invoiceButtonLabel'           => __( 'Print Invoice', 'woocommerce-delivery-notes' ),
			'deliveryNoteButtonLabel'      => __( 'Print Delivery Note', 'woocommerce-delivery-notes' ),
			'receiptButtonLabel'           => __( 'Print Receipt', 'woocommerce-delivery-notes' ),
			'creditNoteButtonLabel'        => __( 'Print Credit Note', 'woocommerce-delivery-notes' ),
			'packingSlipButtonLabel'       => __( 'Print Packing Slip', 'woocommerce-delivery-notes' ),
