...
if ( ! class_exists( 'WCDN_Settings' ) ) {
	...
	class WCDN_Settings {
		...
		public function add_assets() {
			...
			if( isset($_GET['tab']) && $_GET['tab'] == "wcdn-settings" ) {
			...
			wp_localize_script( 'woocommerce-delivery-notes-admin', 'admin_object', array(
		...
		public function output() {
			include_once __DIR__.'/admin/views/wcdn_header.php';
		}

		public function wcdn_remove_shoplogo() {
			if ( !empty( $_POST['shop_logoid'] ) ) {
				update_option('wcdn_company_logo_image_id', '');
				wp_delete_attachment( $_POST['shop_logoid'] );
			}
		}
		...
		//public function get_settings( $section = '' ) {
			//include_once __DIR__.'/admin/wcdn_header.php';
