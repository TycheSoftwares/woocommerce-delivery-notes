...
if ( ! class_exists( 'WooCommerce_Delivery_Notes' ) ) {
	...
	final class WooCommerce_Delivery_Notes {
		...
		public function init_hooks() {
			...
			add_action( 'woocommerce_init', array( $this, 'wcdn_delete_file' ) );
		...
		/**
		 * Delete all pdf after certain time. v.5.0.0.
		 */
		public function wcdn_delete_file() {
			/** Define directory */
			$upload_path       = wp_upload_dir()['basedir'];
