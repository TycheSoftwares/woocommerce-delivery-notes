...
class Template_Engine {
				...
				$structure = array(
					'sections' => array(
						array(
							...
							'items' => self::build_groups( array( 'enabled', 'dateFormat', 'orderMetaPosition', 'pdfFilename', 'attachCustomerEmail', 'attachAdminEmail', 'attachCustomEmails', 'customEmailAddresses', 'attachToOrderStatus', 'orderStatusToAttachTo', 'attachToWoocommerceEmails', 'woocommerceEmailsToAttachTo' ) ),
						),
						array(
							'type'  => 'section',
		...
		self::$components_cache = array(
			...
			'shopPhone'                         => array(
				...
				'items'  => array(
					...
					array(
						...
						'default'   => __( 'Phone', 'woocommerce-delivery-notes' ),
					),
					array(
						'type'      => 'field',
					...
					array(
						'type'      => 'field',
						'field'     => 'shopPhoneMarginTop',
						'schema'    => 'number',
						'fieldType' => 'slider',
						'label'     => __( 'Margin Top', 'woocommerce-delivery-notes' ),
						'default'   => 0,
						'min'       => 0,
						'max'       => 40,
					),
					array(
						'type'      => 'field',
						'field'     => 'shopPhoneMarginBottom',
						'schema'    => 'number',
						'fieldType' => 'slider',
						'label'     => __( 'Margin Bottom', 'woocommerce-delivery-notes' ),
						'default'   => 0,
						'min'       => 0,
						'max'       => 40,
					),
			...
			'shopEmail'                         => array(
				...
				'items'  => array(
					...
					array(
						...
						'fieldType' => 'text',
						'label'     => __( 'Text', 'woocommerce-delivery-notes' ),
						'default'   => __( 'Email', 'woocommerce-delivery-notes' ),
					),
					array(
						'type'      => 'field',
			...
			'billingAddress'                    => array(
				...
				'items'  => array(
					...
					array(
						...
						'fieldType' => 'text',
						'label'     => __( 'Text', 'woocommerce-delivery-notes' ),
						'default'   => __( 'Billing Address', 'woocommerce-delivery-notes' ),
					),
					array(
						'type'      => 'field',
			...
			'billingPhone'                      => array(
				...
				'items'  => array(
					...
					array(
						...
						'options'      => self::field_options( 'alignOptions' ),
						'disabledWhen' => array(
							'field' => 'orderMetaPosition',
							'value' => 'columns',
						),
					),
					array(
						'type'      => 'field',
						'field'     => 'billingPhoneTextColor',
						'schema'    => 'text',
						'fieldType' => 'color',
						'label'     => __( 'Text Color', 'woocommerce-delivery-notes' ),
						'default'   => '#000000',
			...
			'shippingAddress'                   => array(
				...
				'items'  => array(
					...
					array(
						...
						'fieldType' => 'text',
						'label'     => __( 'Text', 'woocommerce-delivery-notes' ),
						'default'   => __( 'Shipping Address', 'woocommerce-delivery-notes' ),
					),
					array(
						'type'      => 'field',
			...
			'orderDataHeader'                   => array(
				...
				'items'          => array(
					...
					array(
						'type'      => 'field',
						'field'     => 'orderDataHeaderText',
						'schema'    => 'text',
						'fieldType' => 'text',
						'label'     => __( 'Text', 'woocommerce-delivery-notes' ),
						'default'   => __( 'Order', 'woocommerce-delivery-notes' ),
					),
					array(
						'type'      => 'field',
						'field'     => 'orderDataHeaderFontSize',
						'schema'    => 'number',
						'fieldType' => 'slider',
						'label'     => __( 'Font Size', 'woocommerce-delivery-notes' ),
						'default'   => 17,
					...
					array(
						'type'      => 'field',
						'field'     => 'orderDataHeaderFontStyle',
						'schema'    => 'text',
						'fieldType' => 'select',
						'label'     => __( 'Font Style', 'woocommerce-delivery-notes' ),
						'default'   => 'bold',
					...
					array(
						'type'      => 'field',
						'field'     => 'orderDataHeaderTextColor',
						'schema'    => 'text',
						'fieldType' => 'color',
						'label'     => __( 'Text Color', 'woocommerce-delivery-notes' ),
						'default'   => '#000000',
					...
					array(
						'type'      => 'field',
						'field'     => 'orderDataHeaderSpacingTop',
						'schema'    => 'number',
						'fieldType' => 'slider',
						'label'     => __( 'Spacing Top', 'woocommerce-delivery-notes' ),
						'default'   => 20,
						'min'       => 0,
						'max'       => 40,
					),
					array(
						'type'      => 'field',
						'field'     => 'orderDataHeaderSpacingBottom',
						'schema'    => 'number',
						'fieldType' => 'slider',
						'label'     => __( 'Spacing Bottom', 'woocommerce-delivery-notes' ),
						'default'   => 5,
						'min'       => 0,
						'max'       => 40,
					),
			...
			/* Order Meta Position */
			'orderMetaPosition'                 => array(
				'type'      => 'field',
				'fieldType' => 'select',
				'field'     => 'orderMetaPosition',
				'label'     => __( 'Template Order Data Position', 'woocommerce-delivery-notes' ),
				'options'   => self::field_options( 'orderMetaPositionOptions' ),
				'schema'    => 'text',
				'default'   => 'below',
			),
			...
			'invoiceNumber'                     => array(
				...
				'items'  => array(
					...
					array(
						...
						'fieldType' => 'text',
						'label'     => __( 'Text', 'woocommerce-delivery-notes' ),
						'default'   => __( 'Invoice No', 'woocommerce-delivery-notes' ),
					),
					array(
						'type'      => 'field',
			...
			'orderNumber'                       => array(
				...
				'items'  => array(
					...
					array(
						...
						'fieldType' => 'text',
						'label'     => __( 'Text', 'woocommerce-delivery-notes' ),
						'default'   => __( 'Order No', 'woocommerce-delivery-notes' ),
					),
					array(
						'type'      => 'field',
			...
			'orderDate'                         => array(
				...
				'items'  => array(
					...
					array(
						...
						'fieldType' => 'text',
						'label'     => __( 'Text', 'woocommerce-delivery-notes' ),
						'default'   => __( 'Date', 'woocommerce-delivery-notes' ),
					),
					array(
						'type'      => 'field',
			...
			'paymentDate'                       => array(
				...
				'items'  => array(
					...
					array(
						...
						'fieldType' => 'text',
						'label'     => __( 'Text', 'woocommerce-delivery-notes' ),
						'default'   => __( 'Payment Date', 'woocommerce-delivery-notes' ),
					),
					array(
						'type'      => 'field',
			...
			'customerNote'                      => array(
				...
				'items'  => array(
					...
					array(
						...
						'fieldType' => 'text',
						'label'     => __( 'Title', 'woocommerce-delivery-notes' ),
						'default'   => __( 'Customer Note', 'woocommerce-delivery-notes' ),
					),
					array(
						'type'      => 'field',
			...
			'showProductCharges'                => array(
				...
				'items'     => array(
					...
					array(
						...
						'schema'    => 'bool',
						'fieldType' => 'checkbox',
						'label'     => __( 'Show Subtotal', 'woocommerce-delivery-notes' ),
						'default'   => true,
					),
					array(
						'type'      => 'field',
						...
						'schema'    => 'bool',
						'fieldType' => 'checkbox',
						'label'     => __( 'Show Tax', 'woocommerce-delivery-notes' ),
						'default'   => true,
					),
					array(
						'type'      => 'field',
						...
						'schema'    => 'bool',
						'fieldType' => 'checkbox',
						'label'     => __( 'Show Shipping', 'woocommerce-delivery-notes' ),
						'default'   => true,
					),
				),
			),
			...
			/* Show Product Images */
			'showProductImages'                 => array(
				'type'   => 'group',
				'id'     => 'showProductImages',
				'label'  => __( 'Show Product Images', 'woocommerce-delivery-notes' ),
				'toggle' => 'showProductImages',
				'items'  => array(
					array(
						'type'      => 'field',
					...
					array(
						'type'      => 'field',
						'field'     => 'productImageSize',
						'schema'    => 'number',
						'fieldType' => 'slider',
						'label'     => __( 'Image Size', 'woocommerce-delivery-notes' ),
						'default'   => 40,
						'min'       => 20,
						'max'       => 100,
					),
	...
	private static function field_options( $option ) {
		...
		$options = array(
			...
			'orderMetaPositionOptions' => array(
				array(
					'label' => __( 'Alongside Addresses', 'woocommerce-delivery-notes' ),
					'value' => 'columns',
				),
				array(
					'label' => __( 'Below Addresses', 'woocommerce-delivery-notes' ),
					'value' => 'below',
				),
			),
		);
